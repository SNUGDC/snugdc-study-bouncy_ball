...
{
    public class ObjectGroup : IElement
    {
        ...
        public ObjectGroup(XElement xObjectGroup)
        {
            Name = (string)xObjectGroup.Attribute("name") ?? "";
            Color = new Color(xObjectGroup.Attribute("color"));
        ...
        public class Object : IElement
        {
            ...
            public Object(XElement xObject)
            {
